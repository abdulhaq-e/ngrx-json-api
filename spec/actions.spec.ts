...
describe('Json Api Actions', () => {
    ...
    it('should have a delete from state action', () => {
        expect(JsonApiActions.DELETE_FROM_STATE).toBeDefined();
        expect(JsonApiActions.DELETE_FROM_STATE).toBe('DELETE_FROM_STATE');
    });
    ...
    it('should create an delete from state action using deleteFromState', () => {
        expect(JsonApiActions.deleteFromState('test')).toEqual({
